...
class TaskServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.GetTask = channel.unary_unary(
                ...
                request_serializer=tasks__pb2.TaskIdRequest.SerializeToString,
...
def add_TaskServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetTask': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTask,
                    request_deserializer=tasks__pb2.TaskIdRequest.FromString,
...
class TaskService:
    ...
    def GetTask(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tasks.TaskService/GetTask',
            tasks__pb2.TaskIdRequest.SerializeToString,
